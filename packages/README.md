...
| `nodesign/` | `@raquezha/nodesign` | CLI package | Usable | Standalone design context extractor CLI for AI agents (Figma, Zeplin), Personal Access Token (PAT) auth CLI, code generator, and preflight brief formatter. |
