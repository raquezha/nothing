...
| **Design** | [`@raquezha/nodesign`](./packages/nodesign) | standalone design context extractor, Personal Access Token (PAT) auth CLI, and preflight tool for AI agents (Figma, Zeplin) |
